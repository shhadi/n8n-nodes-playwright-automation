...
export const playwrightNodeProperties: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		options: [
			{
				name: 'Create',
				value: SessionOperation.Create,
				description: 'Create a new browser session',
				action: 'Create a session',
			},
			{
				name: 'Close',
				value: SessionOperation.Close,
				description: 'Close a browser session',
				action: 'Close a session',
			},
			{
				name: 'Get Storage State',
				value: SessionOperation.GetStorageState,
				description: 'Get cookies and local storage',
				action: 'Get storage state',
			},
		],
	},
	{
	...
	// ----------------------------------
	{
		...
		options: [
			{
				name: 'Navigate',
				value: PageOperation.Navigate,
				description: 'Navigate to a URL',
				action: 'Navigate to a url',
			},
			{
				name: 'Click',
				value: PageOperation.Click,
				description: 'Click an element',
				action: 'Click an element',
			},
			{
				name: 'Type/Fill',
				value: PageOperation.Fill,
				description: 'Type into an input field',
				action: 'Type into an element',
			},
			{
				name: 'Wait',
				value: PageOperation.Wait,
				description: 'Wait for time or selector',
				action: 'Wait',
			},
			{
				name: 'Get Text',
				value: PageOperation.GetText,
				description: 'Get element text content',
				action: 'Get text',
			},
			{
				name: 'Get HTML',
				value: PageOperation.GetHTML,
				description: 'Get element or page HTML',
				action: 'Get html',
			},
			{
				name: 'Get Attribute',
				value: PageOperation.GetAttribute,
				description: 'Get element attribute',
				action: 'Get attribute',
			},
			{
				name: 'Count Elements',
				value: PageOperation.Count,
				description: 'Count matching elements',
				action: 'Count elements',
			},
			{
				name: 'Screenshot',
				value: PageOperation.Screenshot,
				description: 'Take a screenshot',
				action: 'Take a screenshot',
			},
			{
				name: 'PDF',
				value: PageOperation.PDF,
				description: 'Generate PDF',
				action: 'Generate pdf',
			},
			{
				name: 'Upload File',
				value: PageOperation.Upload,
	...
	// ----------------------------------
	{
		...
		options: [
			{
				name: 'Run Script',
				value: ScriptOperation.Run,
				description: 'Run a custom Playwright script',
				action: 'Run a custom script',
			},
		],
	},
	{
